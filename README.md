...
**Programming Languages**:
   ...
   - JavaScript <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank"><img  alt='[JavaScript Logo]' height='40' width='40' src="https://upload.wikimedia.org/wikipedia/commons/6/6a/JavaScript-logo.png" /></a>
   - TypeScript <a href="https://www.typescriptlang.org/" target="_blank"><img alt='[TypeScript Logo]' height='40' width='40' src="https://upload.wikimedia.org/wikipedia/commons/4/4c/Typescript_logo_2020.svg" /></a>
   - Python  <a href="https://www.python.org/" target="_blank"><img  alt='[Python Logo]' height='40' width='40' src="https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg" /></a>
   - C/C++ <a href="https://isocpp.org/" target="_blank"><img  alt='[C/C++ Logo]' height='40' width='40' src="https://upload.wikimedia.org/wikipedia/commons/1/18/ISO_C%2B%2B_Logo.svg" /></a>
   - PHP  <a href="https://www.php.net/" target="_blank"><img  alt='[PHP Logo]' height='40' width='40' src="https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg" /></a>

**Programming Framework's**:

   - Angular 2+ <a href="https://angular.io/" target="_blank"><img  alt='[Angular Logo]' height='40' width='40' src="https://angular.io/assets/images/favicons/favicon.ico" /></a>
   - React <a href="https://react.dev/" target="_blank"><svg width="100%" height="100%" viewBox="-10.5 -9.45 21 18.9" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-sm me-0 w-10 h-10 text-link dark:text-link-dark flex origin-center transition-all ease-in-out"><circle cx="0" cy="0" r="2" fill="currentColor"></circle><g stroke="currentColor" stroke-width="1" fill="none"><ellipse rx="10" ry="4.5"></ellipse><ellipse rx="10" ry="4.5" transform="rotate(60)"></ellipse><ellipse rx="10" ry="4.5" transform="rotate(120)"></ellipse></g></svg></a>
   - Vue  <a href="https://vuejs.org/" target="_blank"><svg class="logo" viewBox="0 0 128 128" width="24" height="24" data-v-87ac3bb2=""><path fill="#42b883" d="M78.8,10L64,35.4L49.2,10H0l64,110l64-110C128,10,78.8,10,78.8,10z" data-v-87ac3bb2=""></path><path fill="#35495e" d="M78.8,10L64,35.4L49.2,10H25.6L64,76l38.4-66H78.8z" data-v-87ac3bb2=""></path></svg></a>
